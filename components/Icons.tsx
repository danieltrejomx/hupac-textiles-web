...
// 6. Iconos Especiales para Configurador
export function IconPolo({ size = 20, color = 'currentColor', className, style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
      <path d="M20.38 3.46L16 2a4 4 0 0 1-8 0L3.62 3.46a2 2 0 0 0-1.34 1.88v3.31a2 2 0 0 0 1.25 1.86l2.47.99V20a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-8.5l2.47-.99a2 2 0 0 0 1.25-1.86V5.34a2 2 0 0 0-1.34-1.88z" />
      <path d="M12 2v7" />
...
export function IconPlayeraRound({ size = 20, color = 'currentColor', className, style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
      <path d="M20.38 3.46L16 2a4 4 0 0 1-8 0L3.62 3.46a2 2 0 0 0-1.34 1.88v3.31a2 2 0 0 0 1.25 1.86l2.47.99V20a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-8.5l2.47-.99a2 2 0 0 0 1.25-1.86V5.34a2 2 0 0 0-1.34-1.88z" />
...
export function IconCamisa({ size = 20, color = 'currentColor', className, style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
      <path d="M20.38 3.46L16 2a4 4 0 0 1-8 0L3.62 3.46a2 2 0 0 0-1.34 1.88v3.31a2 2 0 0 0 1.25 1.86l2.47.99V20a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-8.5l2.47-.99a2 2 0 0 0 1.25-1.86V5.34a2 2 0 0 0-1.34-1.88z" />
      <path d="M12 2v18" />
...
export function IconMezclilla({ size = 20, color = 'currentColor', className, style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
      <path d="M20.38 3.46L16 2a4 4 0 0 1-8 0L3.62 3.46a2 2 0 0 0-1.34 1.88v3.31a2 2 0 0 0 1.25 1.86l2.47.99V20a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-8.5l2.47-.99a2 2 0 0 0 1.25-1.86V5.34a2 2 0 0 0-1.34-1.88z" />
      <path d="M12 2v18" />
      <path d="M9 2l3 4 3-4" />
      <rect x="7" y="10" width="3" height="3.5" rx="0.5" />
      <rect x="14" y="10" width="3" height="3.5" rx="0.5" />
    </svg>
  );
}

export function IconReflectiveStripes({ size = 20, color = 'currentColor', className, style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
      <path d="M4 4h16l-2 5v11a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V9L4 4z" />
      <line x1="6" y1="12" x2="18" y2="12" strokeWidth="2.2" stroke={color} />
      <line x1="6" y1="16" x2="18" y2="16" strokeWidth="2.2" stroke={color} />
      <line x1="10" y1="4" x2="8" y2="12" strokeWidth="1.8" stroke={color} />
      <line x1="14" y1="4" x2="16" y2="12" strokeWidth="1.8" stroke={color} />
    </svg>
  );
}

export function IconRotate({ size = 18, color = 'currentColor', className, style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
...
export function IconDownload({ size = 18, color = 'currentColor', className, style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
...
export function IconTicket({ size = 18, color = 'currentColor', className, style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
...
export function IconUploadCloud({ size = 18, color = 'currentColor', className, style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
...
export function IconCheckSimple({ size = 18, color = 'currentColor', className, style }: IconProps) {
  return (
...
export function IconInfoCircle({ size = 18, color = 'currentColor', className, style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
      <circle cx="12" cy="12" r="10" />
...
export function IconEye({ size = 18, color = 'currentColor', className, style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
