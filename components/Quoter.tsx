    ...
    <section id="cotizador" style={{ paddingTop: '24px' }} ref={ref}>
      <div className="cotiza rv">
        ...
        <div style={{ display: 'flex', gap: '14px', justifyContent: 'center', flexWrap: 'wrap' }}>
          <a className="btn ws" id="btnWhats" href="https://wa.me/525516257933" target="_blank" rel="noopener noreferrer">
        ...
        <p className="nota" style={{ marginTop: '22px' }}>Tel. y WhatsApp: 55 1625 7933</p>
      </div>
    </section>
  );
}
